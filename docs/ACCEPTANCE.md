...
| Usable timetable export | Styled print sheet and quoted CSV share `timetableRows()` fields: time, end, stage, act, audience, budget | Source implemented; print preview pending |
